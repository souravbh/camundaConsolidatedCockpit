...
processDefinition: any
  ...
  this.http.get('http://localhost:8080/rest/history/process-instance').subscribe(data => {
    this.processInstance = data;
      console.log(data);
    }); 
    
    this.http.get('http://localhost:8080/rest/process-definition').subscribe(data => {
